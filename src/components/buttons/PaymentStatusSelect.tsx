                ...
                <div className={`bg-white border rounded-md relative shadow-md flex items-start justify-between gap-2 w-80 status-toast`} role="alert">
                    <div>
                        ...
                        <span className="block sm:inline">
                            Statut de facturation de la commande n° {idCommande} mis à jour de <span className="text-[#f18c08]">{statutActuel}</span> à <span className="text-[#f18c08]">{nouveauStatut}</span>.
                        </span>
                    </div>
                    <button
